...
class lct_fk(nn.Module):
    ...
    def forward(self, feture_bxdxtxhxw, tbes, tens):
        ...
        # bnum:batch size; dnum: dim num; tnum: temporal dim num; wnum and hnum: w and h size; tbes: original bin num
        ...
        # datafre_BDX2Tx2Hx2Wx2 = torch.view_as_real(torch.fft.fft(datapad_BDx2Tx2Hx2W, dim=3))
        datafre_BDX2Tx2Hx2Wx2 = torch.view_as_real(torch.fft.fftn(datapad_BDx2Tx2Hx2W, dim=(-3, -2, -1)))
        ...
        data_pre = torch.view_as_complex(tdata_BDx2Tx2Hx2Wx2)
        data = torch.fft.ifftn(data_pre, dim=(-3, -2, -1))
